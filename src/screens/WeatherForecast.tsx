...
import { ActivityIndicator, View, StyleSheet, Text, ScrollView, TouchableOpacity, Button } from 'react-native';
...
const WeatherItemComponent = (props: any) => {
  ...
  moment.locale('zh-tw');
  let formatDate = moment(props.items.forecastDate, "YYYYMMDD").format("MMMDo");
  return(
  <View style={ styles.weatherItem }>
    <View style={{flex: 1, paddingRight: 8}}>
      <Text style={[styles.defaultText, {width: "100%", textAlign: "center"}]}>{ formatDate }{"\n"}({ props.items.week })</Text>
      <View style={{backgroundColor: "#1b5397", borderRadius: 15, padding: 5, marginTop: 10}}>
        <FullWidthImage source={{ uri: forecastIcon }} />
      </View>
    </View>
...
const WeatherItemHtml = (items: any) => {
  ...
  moment.locale('zh-tw');
  let formatDate = moment(items.forecastDate, "YYYYMMDD").format("MMMDo");
      ...
      <ScrollView>
        <View style={{ padding: 14, paddingBottom: 34 }}>
          ...
          <TouchableOpacity onPress={() => { navigation.navigate('ZoomImage', { source: {uri: img1} }) }}>
            <FullWidthImage source={{ uri: img1 }} />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => { navigation.navigate('ZoomImage', { source: {uri: img2} }) }}>
            <FullWidthImage source={{ uri: img2 }} />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => { navigation.navigate('ZoomImage', { source: {uri: img3} }) }}>
            <FullWidthImage source={{ uri: img3 }} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
