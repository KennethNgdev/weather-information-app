...
export default function ZoomImage({ navigation, route }) {
  ...
  const onLayout = useCallback((event) => {
    ...
    //   setHeight(containerWidth * route.params.ratio);
    // } else if (typeof route.params.source === "number") {
    //   const source = Image.resolveAssetSource(route.params.source);

    //   setWidth(containerWidth);
    //   setHeight(containerWidth * source.height / source.width);
    // } else if (typeof route.params.source === "object") {
